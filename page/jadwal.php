...
<?php
$no=1;
$sql=mysql_query("select * from tbpeserta, tbmahasiswa, tbsertifikasi where tbpeserta.id_mahasiswa=tbmahasiswa.id_mahasiswa and tbpeserta.id_sertifikasi=tbsertifikasi.id_sertifikasi and tbpeserta.status='Selesai'");
while ($data= mysql_fetch_array($sql))
{
	echo"
		<tr>
			...
			<td>$data[status]</td>
			<td><a href=index.php?page=jadwal&view=tentukan&id=$data[id_peserta] class='btn btn-info'><i class=\"fa fa-mail-forward\"></i></a></td>
		</tr>		
		";
		$no++;
}
			...
			<form action="" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="hidden" class="form-control" value="<?php echo $data['id_mahasiswa'] ?>" name="id_mahasiswa" >
                </div>
              </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
                <label>Sertifikasi</label>
					<div class="input-group">
						...
						<input type="hidden" class="form-control" value="<?php echo $data['id_sertifikasi'] ?>" name="id_sertifikasi" >
					</div>
			  </div>
			  <div class="row">
				<div class="col-md-4">
